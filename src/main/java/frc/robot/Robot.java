...
public class Robot extends TimedRobot {
  ...
  CANSparkMax right = new CANSparkMax(2,MotorType.kBrushless);

  CANSparkMax leftFollower = new CANSparkMax(4,MotorType.kBrushless);
  ...
  public void robotPeriodic() {
    ...
    servo.set((stick.getRawAxis(2)+1)/2);
  }
